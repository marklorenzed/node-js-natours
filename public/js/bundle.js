  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = type === 'password' ? 'http://localhost:3002/api/v1/users/updateMyPassword' : 'http://localhost:3002/api/v1/users/updateMe';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFya2xvcmVuemVkIiwiYSI6ImNrOGw5dmZlZzAxa3AzbW55MjAzNTQ2YmQifQ.VADTXzblcyxCqHBJ0acFFg';
...
var stripe = Stripe('pk_test_o1z32tbIzEJHdOXlFZsDAgih00vGpBHdQz');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3002/api/v1/bookings/checkout-session/".concat(tourId));
